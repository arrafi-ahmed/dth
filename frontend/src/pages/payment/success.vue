<script setup>
  ...
  function clearRegistrationLocalStorage () {
    try {
      ...
      console.warn('Local storage cleanup failed', error_)
    }
  }
  ...
  <v-container class="fill-height pa-0">
    <v-row align="center" class="fill-height" justify="center" no-gutters>
      ...
      <v-col
        ...
        sm="8"
      >
        <v-card border class="text-center pa-10 rounded-xl" variant="outlined">
      ...
      >
        ...
        <div class="text-center mb-8">
          <v-avatar class="mb-4 elevation-4" color="success" size="72">
          ...
          <v-chip v-if="tempRegistration.status === 'pending'" class="mt-2" color="warning" variant="tonal">
            Processing final confirmation...
          </v-chip>
        </div>

        <v-card class="elevation-1 border overflow-hidden" :rounded="rounded">
