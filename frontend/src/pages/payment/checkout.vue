  ...
  async function handleApplyPromoCode () {
    ...
    try {
      ...
      if (response.data?.payload) {
        ...
        discountVal = promo.discountType === 'percentage' ? Math.round((subtotal * (promo.discountValue || 0)) / 100) : Number(promo.discountValue || 0)
        ...
        if (taxConfig && netSubtotal > 0) {
          newTax = taxType === 'percent' ? Math.round((netSubtotal * taxConfig) / 100) : Math.round(Number(taxConfig))
        }
                ...
                <div>
                  ...
                  <div v-if="selectedProducts?.length" class="mb-6">
                    <div class="d-flex align-center mb-3">
                      <v-icon class="mr-2" color="primary">mdi-truck-delivery-outline</v-icon>
                    ...
                    <v-select
                      ...
                      variant="outlined"
                    />
                    <v-alert v-if="selectedShippingOption === 'pickup'" class="mt-3 text-caption" type="info" variant="tonal">
                    ...
                    <div class="payment-grid">
                      ...
                      >
                        <div class="d-flex align-center pa-4">
                          <v-radio class="ma-0 mr-2" color="primary" :value="method.value" />
                          <v-avatar class="mr-3" :color="method.color" size="40" variant="tonal">
                ...
                <div class="py-4">
                  ...
                  <template v-else-if="clientSecret || totalAmount === 0">
                    ...
                    <div v-if="totalAmount === 0" class="text-center py-4">
                      <v-icon class="mb-4" color="success" size="64">mdi-ticket-percent-outline</v-icon>
